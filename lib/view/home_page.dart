...
class _HomePageState extends State<HomePage> {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('✨ 마이그레이션 성공!')),
        );
      }
    } catch (e) {
      if (mounted) {
    ...
    return ValueListenableBuilder<Box>(
      ...
      builder: (context, box, _) {
        ...
        final Map<String, dynamic>? lastPath = box.get('last_study_path') != null
            ...
            : null;
        final Map<String, dynamic>? testSession = box.get('level_test_session') != null
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          ListTile(
                            ...
                            onTap: () async {
                              Navigator.pop(context);
                              await Hive.box(DatabaseService.sessionBoxName)
                                  .put('master_data_version', 0.0);
                              if (mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(content: Text('Sweep 처리가 완료되었습니다.')));
                              }
                            },
                          ),
                          const Divider(),
                          ListTile(
                            ...
                            subtitle: Text(box.get('master_data_version',
                                    defaultValue: 1.0)
                                .toString()),
                          ),
                        ],
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            Expanded(
                              child: lastPath != null
                                  ? _buildDashCard(
                                      context,
                                      "이어하기",
                                      "${lastPath['level']} D-${lastPath['day_index'] + 1}",
                            ...
                            Expanded(
                              child: recommendedLevel != null
                                  ...
                                  : _buildDashCard(
                                      ...
                                      isDarkMode, () {
                                      if (testSession != null) {
                                        _showResumeTestDialog(context, pointColor,
                                            isDarkMode, testSession);
                                      } else {
                                        _showLevelTestGuide(
                                            context, pointColor, isDarkMode);
                                      }
                                    }),
                            ),
                          ],
                        ...
                        GridView.count(
                          ...
                          children: [
                            _buildLevelCard(
                                context, 'N5', '입문', Colors.green, isDarkMode),
                            _buildLevelCard(context, 'N4', '초급',
                                Colors.lightGreen, isDarkMode),
                            _buildLevelCard(
                                context, 'N3', '중급', Colors.blue, isDarkMode),
                            _buildLevelCard(
                                context, 'N2', '상급', Colors.indigo, isDarkMode),
                            _buildLevelCard(
                                context, 'N1', '전문', Colors.purple, isDarkMode),
                          ],
                        ),
                        const SizedBox(height: 20),
                        const Text("나의 관리",
  ...
  Widget _buildDashCard(BuildContext context, String title, String subtitle,
      IconData icon, Color color, bool isDarkMode, VoidCallback? onTap) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
  ...
  Widget _buildLevelCard(
      BuildContext context, String level, String desc, Color color, bool isDarkMode) {
    return GestureDetector(
  ...
  Widget _buildCategoryCard(BuildContext context, String title, String subtitle,
      IconData icon, Color color, VoidCallback onTap, bool isDarkMode,
      {bool isTall = false}) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
  ...
  void _showLevelTestGuide(
      BuildContext context, Color themeColor, bool isDarkMode) {
    showDialog(
        context: context,
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text(
                      ...
                      style: TextStyle(
                          ...
                          height: 1.6)),
                  const SizedBox(height: 24),
                  _buildGuideItem(Icons.playlist_add_check_rounded,
                      "총 30개 문항 (레벨별 핵심 단어)", isDarkMode, themeColor),
                  _buildGuideItem(Icons.timer_outlined, "예상 소요 시간: 약 10분",
                      isDarkMode, themeColor),
                  _buildGuideItem(Icons.analytics_outlined, "취약 구간 분석 및 맞춤형 로드맵",
                      isDarkMode, themeColor),
  ...
  void _showResumeTestDialog(BuildContext context, Color themeColor,
      bool isDarkMode, Map<String, dynamic> session) {
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text("테스트 이어하기",
                      style: TextStyle(
                          ...
                          color: isDarkMode ? Colors.white : Colors.black87)),
                  const SizedBox(height: 12),
                  Text("이전에 $currentNum번 문제까지 풀었습니다.\n기록을 이어서 진행하시겠습니까?",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontSize: 15,
                          color: isDarkMode ? Colors.white70 : Colors.blueGrey,
